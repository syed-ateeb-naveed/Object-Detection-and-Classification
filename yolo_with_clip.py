...
#     try:
#         ffmpeg.input(video_path).output(output_pattern, vf=f'fps={frame_rate}').run(capture_stdout=True, capture_stderr=True)
            ...
            if choice == "By Image":
                ...
                if video_file:
                    ...
                    with st.spinner("📸 Extracting frames..."):
                        frames, frame_indices = extract_frames_cv2(temp_video_path, extracted_folder, frame_rate=5)
